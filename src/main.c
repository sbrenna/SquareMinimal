...
static void main_window_load(Window *window) 
{
  ...
  s_time_layer = text_layer_create(GRect(72, 30, 72, 110));
 ...
 // s_time_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_CUSTOM_LIGHT_24));
  s_time_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_PIR_39));
  ...
  //Day
  s_day_label = text_layer_create(GRect(0,50,72,60));
  ...
  layer_add_child(window_layer, bitmap_layer_get_layer(s_w_layer));
  layer_add_child(window_layer, bitmap_layer_get_layer(s_nw_layer));
  layer_add_child(window_layer, text_layer_get_layer(s_city_layer));
  layer_add_child(window_layer, text_layer_get_layer(s_tempf_layer));
